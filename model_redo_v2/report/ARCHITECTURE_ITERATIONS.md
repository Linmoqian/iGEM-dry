...
> 轮次编号说明：本文件为 **R1–R8**；训练迭代见 [迭代记录.md](迭代记录.md)（**I0–I5 + 种子复核**，共 7 轮）；
> 数据审计/基线门禁/代码审查见 [ARCHITECTURE_REVIEWS_EXTRA.md](ARCHITECTURE_REVIEWS_EXTRA.md)（**R9–R24**，共 16 轮）。
> 三者合计 **31 轮** ≥ 20 轮，总索引见 [ARCHITECTURE_REVIEWS_EXTRA.md](ARCHITECTURE_REVIEWS_EXTRA.md) 附表。
