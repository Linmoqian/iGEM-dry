...
![XGBoost ROC/PR 曲线](../../figures/XGBoost/roc_pr_curves.webp)

**混淆矩阵：**

![XGBoost 混淆矩阵](../../figures/XGBoost/confusion_matrix.webp)
...
![Ensemble 预测 vs 真实](../../figures/Ensemble/predicted_vs_actual.webp)

**残差分布（Ensemble）：**

![Ensemble 残差分布](../../figures/Ensemble/residuals.webp)
...
![SHAP 蜂群图](../../figures/shap/shap_beeswarm.webp)

**SHAP 柱状图** 展示了各特征平均绝对 SHAP 值的排名：

![SHAP 柱状图](../../figures/shap/shap_bar.webp)
...
![CHLA_RESULT SHAP 依赖图](../../figures/shap/dependence/shap_dependence_CHLA_RESULT.webp)
...
![SHAP 瀑布图 - 高预测值样本](../../figures/shap/waterfall/shap_waterfall_165.webp)
...
| 目录 | 文件 | 说明 |
|------|------|------|
| XGBoost/ | confusion_matrix.webp | 分类混淆矩阵 |
| | roc_pr_curves.webp | ROC + PR 曲线 |
| | predicted_vs_actual.webp | 回归预测 vs 实际 |
| | residuals.webp | 残差分布 |
| LightGBM/ | 同上 | 同上 |
| Ensemble/ | 同上 | 同上 |
| shap/ | shap_beeswarm.webp | 全局特征重要性蜂群图 |
| | shap_bar.webp | 平均绝对 SHAP 值排名 |
| | dependence/*.webp | Top 特征依赖图 |
| | waterfall/*.webp | 代表性样本瀑布图 |
